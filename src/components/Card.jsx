...
const items = [
  {
    ...
    desc: "An e-commerce website for banana sales. Built with Laravel Blade as a special project.",
    img: "/website-pisang.png",
